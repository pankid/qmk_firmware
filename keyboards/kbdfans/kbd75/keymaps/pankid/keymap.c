...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,   KC_SPC,   KC_SPC,                       MO(2),  MO(1),    TO(3),  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [3] = LAYOUT(
    ...
    KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,                      KC_ENT,   KC_PGDN,
    KC_LSFT,  MO(1),    KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,            KC_UP,    KC_END,
    KC_LALT,  KC_LGUI,  KC_LCTL,                      KC_SPC,   KC_SPC,   KC_SPC,                       MO(2),  MO(1),    TO(1),  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
